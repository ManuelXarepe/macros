...
//   TString filename = "/lustre/r3b/mxarepe/sweep_lmd/main* --allow-errors --input-buffer=135Mi";
   TString filename = "/lustre/r3b/mxarepe/stitched_sweep/main0167_000* --allow-errors --input-buffer=135Mi";
...
//   TString outputFileName = "/u/land/mxarepe/unpkd_data/analysis/rootfiles/main0165_0001_TS.root";
   TString outputFileName = "output_sweepb.root";
  // TString outputFileName = "self_trigger.root";
...
//   TString calFile = "parameter_beam.root";
   TString calFile = "RpcPosHitcalPar_sweep0001.root";
