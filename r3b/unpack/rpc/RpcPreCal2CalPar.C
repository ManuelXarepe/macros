...
void RpcPreCal2CalPar(Int_t RunId=1)
{
   ...
   run->SetSource(source);
    ...
    TString calFile = "RpcTcalPar_sweep0001.root";
//    TString calFile = "RpcTcalPar0001.root";
    ...
    TString parFileName = "RpcTotcalPar_sweep_"+runNumber+"_new.root";  // name of parameter file
    //TString parFileName = "RpcTotcalPar_"+runNumber+".root";  // name of parameter file
    ...
    R3BRpcPreCal2CalPar* RpcCalibrator = new R3BRpcPreCal2CalPar("RpcTotCalPar", 1);
